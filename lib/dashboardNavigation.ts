...
export function getDashboardFeatureRoute(
  ...
  if (userType === 'student') {
    const routeMap: Record<string, string> = {
      ...
      jobs: `${baseRoute}/market-jobs`,
      'market-jobs': `${baseRoute}/market-jobs`,
      'virtual-internships': `${baseRoute}/virtual-internships`,
  ...
  if (userType === 'college') {
    const routeMap: Record<string, string> = {
      ...
      intelligence: `/dashboard/college/intelligence`,
  ...
  if (userType === 'admin') {
    const routeMap: Record<string, string> = {
      ...
      'virtual-internships-admin': `/dashboard/admin/virtual-internships`,
